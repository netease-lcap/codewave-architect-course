...
public class RedisService {
    ...
    // */
    // @NaslLogic
    // public Map<String, String> setHashValues(String hashKey, Map<String, String>
    // keyValueMap) {
    ...
    // */
    // @NaslLogic
    // public Map<String, String> getHashValues(String hashKey, List<String>
    // fieldKeys) {
    // HashOperations<String, String, String> ops = redisTemplate.opsForHash();
    ...
    // /**
    // * 根据传入的 key 和 field 列表查询 Redis 中对应的值，并将查询结果存储在一个 Map<String, Map<String,
    // String>> 中
    // *
    // * @param keyAndFieldsMap Map<String, String>，其中 key 是 Redis 中的 key，value
    // 是要查询的 field
    // * @return Map<String, Map < String, String>>，其中外层的 key 是 Redis 中的 key，内层的
    // key-value 对是 field 和它对应的值
    // */
    // @NaslLogic
    // public Map<String, Map<String, String>>
    // getHashValuesByKeysAndField(Map<String, String> keyAndFieldsMap) {
    // HashOperations<String, String, String> ops = redisTemplate.opsForHash();
    ...
    // String>> 中
    // *
    // * @param keyAndFieldsMap Map<String, List<String>>，其中 key 是 Redis 中的
    // key，value 是要查询的 hashMap 中对应的 field 的列表
    // * @return Map<String, Map < String, String>>，其中外层的 key 是 Redis 中的 key，内层的
    // key-value 对是 field 和它对应的值
    // */
    // @NaslLogic
    // public Map<String, Map<String, String>>
    // getHashValuesByKeysAndFiledList(Map<String, List<String>> keyAndFieldsMap) {
    // HashOperations<String, String, String> ops = redisTemplate.opsForHash();
    // Map<String, Map<String, String>> resultMap = new HashMap<>();
    ...
    // */
    // @NaslLogic
    // public Boolean hashSetIfNotExists(String hashKey, String fieldKey, String
    // value) {
    // HashOperations<String, String, String> ops = redisTemplate.opsForHash();
    ...
    // */
    // @NaslLogic
    // public Double hashIncrementByFloat(String hashKey, String fieldKey, Double
    // increment) {
    // HashOperations<String, String, String> ops = redisTemplate.opsForHash();
    // return ops.increment(hashKey, fieldKey, increment);
    // }
