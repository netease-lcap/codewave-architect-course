...
public class FreeMarkerExample {
    ...
    public void test1() throws TemplateException, IOException {
        ...
        //获取模板文件路径
        String srcFilePath = FreeMarkerExample.class.getClassLoader().getResource("templates/v3_13/src/main/java/com/netease/cloud/archetype/functional").getFile();
